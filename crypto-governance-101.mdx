...
**Guided by Runbooks and Best Practices:**

Throughout this gradual transition, Agora's Runbooks and advisory services help your community navigate key milestones. Whether it's choosing the right moment to lower proposal thresholds, formalizing a security council, or scaling treasury management, you'll have access to proven strategies and recommended steps.

<Note>
  Not all Agora plans come with full runbooks and 1:1 consulting. If you are
  unsure let us know and we can direct you to the right package.
</Note>
